...
<body class="signup-page bg-blue-grey">
    <div class="signup-box">
        <div class="logo">
            <a href="javascript:void(0);">E-POS Bengkel <b>MOTOR</b></a>
            
        </div>
        <div class="card">
            <div class="header bg-black">
                <h5 class="text-center">Register a new membership</h5>
            </div>
            <div class="body">
                <form id="sign_up" method="POST" action="proses_signup.php">
